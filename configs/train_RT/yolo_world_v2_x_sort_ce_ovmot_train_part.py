...
detector['bbox_head']['use_PCS'] = False
...
train_dataset_tpye = 'Taov1_TrainDataset'
...
val_dataloader = dict(
    ...
    dataset=dict(
		...
		ann_file='data/tao/annotations/tao_val_lvis_v1_classes_part.json',
...
train_dataloader = dict(
    ...
    num_workers=1,
    persistent_workers=True,
    sampler=dict(type='mmdet.TrackImgSampler'),
    dataset=dict(
        type=train_dataset_tpye,
		data_root='',
        ann_file='data/tao/annotations/train_ours_f_part.json',
        data_prefix=dict(img_path='data/tao/frames/'),
        test_mode=False,
