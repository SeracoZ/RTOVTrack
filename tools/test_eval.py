...
def main():
    ...
    # todo: add detector re-parameter here
    print('\n')
    print(80*'*')
    # print('classes in val dataset:', runner.val_dataloader.dataset.METAINFO['classes'])
    # print('num of classes in val dataset:', len(runner.val_dataloader.dataset.METAINFO['classes'])) #1203

    #texts = [list(runner.val_dataloader.dataset.METAINFO['classes'])[:40] + [' ']]
    texts = [list(runner.val_dataloader.dataset.METAINFO['classes'])]

    runner.model.detector.reparameterize(texts)
    print('\n')
    print(80 * '=')
